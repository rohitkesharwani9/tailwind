...
const Title = (): JSX.Element => {
  ...
  return (
    <div className='px-4 text-lg text-center text-slate-600 dark:text-slate-400'>
      ...
      <Link passHref href='/'>
        <a>
          <h1 className='absolute top-0 items-end justify-center invisible hidden text-5xl font-semibold origin-left -translate-x-1/2 index-title left-1/2 sm:flex text-slate-700 dark:text-slate-300'>
            ...
            <span className=''>Tailwind Helper</span>
          </h1>
        </a>
      </Link>
      {/* DESCRIPTION */}
      ...
      Struggling to remember property names? Want to map a unit to its Tailwind class effortlessly? Or are you just starting out with Tailwind and need help visualizing its classes? This tool might be exactly what you need
      </p>
    </div>
  )
}
