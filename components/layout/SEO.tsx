...
const SEO = ({ isDark }: Props): JSX.Element => {
  const description =
    'A Tailwind multi-tool designed for converting and visualizing class properties.'
  const title = 'Tailwind Helper'
  return (
    <Head>
      <>
        <link
      ...
      <link rel='canonical' href='https://tailwindhelper.tech' />
      ...
      <meta property='og:url' content='https://tailwindhelper.tech' />
      <meta property='og:title' content={title} />
      <meta property='og:description' content={description} />
      <meta property='og:image' content='/og-image.png' />

      <meta property='twitter:card' content='summary' />
      <meta property='twitter:url' content='https://tailwindhelper.tech/' />
